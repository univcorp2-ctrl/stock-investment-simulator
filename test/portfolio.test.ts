...
const quotes: QuotePoint[] = [
  { symbol: "AAPL.US", date: "2026-05-12", close: 120, previousClose: 115, change: 5, changePct: 5 / 115 },
  { symbol: "MSFT.US", date: "2026-05-12", close: 180, previousClose: 190, change: -10, changePct: -10 / 190 }
];

describe("calculatePortfolioReturns", () => {
  it("calculates position and portfolio returns", () => {
